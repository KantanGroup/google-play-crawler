...
public class GooglePlayAPI {
	 ...
	 * Constructs a ready to login {@link GooglePlayAPI}.
	 */
	public GooglePlayAPI(String email, String password, String androidId, UserAgent userAgent) {
		this(email, password, androidId);
	...
	this.androidId = BigInteger.valueOf(checkinResponse.getAndroidId()).toString(16);
    ...
    /**
     * Gets header parameters for GET/POST requests.
     */
	private String[][] getHeaderParameters( String token, String contentType ) {
		return new String[][] {
				...
				{"User-Agent",
						//"Android-Finsky/4.6.17 (versionCode=80260017,sdk=19,device=ghost,hardware=qcom,product=ghost,build=KXA21.12-L1.29.1:user)" },
						userAgent.toString()},
